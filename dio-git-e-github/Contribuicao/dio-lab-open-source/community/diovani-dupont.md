...
- Profissional graduado em Análise e Desenvolvimento de Sistemas com formação em negócios Internacionais e Comércio Exterior, procurando uma oportunidade na área de dados e/ou tecnologia, onde posso melhorar e expandir meus conhecimentos, sempre buscando uma boa qualificação profissional.
- Conhecimento em análise, extração, tratamento e manipulação de dados, com a preparação de relatórios de gerenciamento, gráficos, monitoramento de indicadores de desempenho e fornecimento de subsídios para apoiar a tomada de decisões estratégicas.
- Conhecimento técnico acadêmico em ciência de dados, big data, aprendizado de máquina, inteligência artificial e desenvolvimento de back-end, confiando no uso de idiomas/ferramentas e tecnologias: linguagens de programação: Python, SQL, R e Java; Bibliotecas Python: Pandas, Numpy, Matplotlib, Scipy, Seaborn e Tensorboard; Ferramentas de Big Data: Apache Hadoop, HDFS, Apache Spark, MapReduce, Yarn, Hive, Data Lake, Docker, Spark Streaming, Spark GraphX, Mllib, Spark SQL e Databricks. Ferramentas de aprendizado de máquina: Tensorflow, Keras, Pytorch, Scikit-Learn, Bayes ingênuos, regressão linear, árvores de decisão, floresta aleatória, redes neurais, máquinas de vetor de suporte (SVM) e recomendação; Bancos de dados relacionais: MySQL, Oracle Database, PostGres/SQL e IBM DB2; Bancos de dados não relacionais: MongoDB, Amazon DynamoDB e Redis.
- Participação ativa no desenvolvimento de novos projetos e soluções, também realizando pesquisas e análises de tendências e fatores de mercado econômicos financeiros, identificando oportunidades de negócios e desenvolvendo estratégias para garantir o funcionamento adequado da operação.
- Profissional qualificado para trabalhar em uma equipe, dinâmico, com iniciativa, facilidade de aprendizado e boas habilidades interpessoais, dedicadas a funções, focadas nos resultados e redução de custos. Organizado, responsável e flexível.
...
- Confira meu site com um portfólio de projetos que desenvolvi: | [SITE](https://diovani-dupont.github.io/)
  
- Confira meu kaggle: | [SITE](https://www.kaggle.com/diodupont)

- Confira meus projetos em ciência de dados: | [SITE](https://medium.com/@diovani.dupont/web-scraping-eda-e-modelo-para-previs%C3%A3o-de-pre%C3%A7os-3c4cf24e252e)
