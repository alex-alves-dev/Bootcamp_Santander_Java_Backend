...
I have experience in various programming languages such as Java, Python, JavaScript, C++, C#, and in frameworks such as Spring Boot, Flask, Qt and SFML. I also have experience with SQL and NoSQL databases, versioning tools and web development. My <a href="https://docafavarato.github.io">online portfolio</a> shows some of my projects involving web development, desktop applications, management systems, REST APIs development, web scraping tools, game development and more.
